...
Variable P : NNat -> Prop.


Hypothesis ind_n : forall n:NNat, (forall k:{v:Z | v >= 0 /\ v < `n}, P ltac:(upcast k)) -> P n.

Theorem nat_lt_ind (n: NNat) : P n.
...
Variable P : NNat -> NNat -> Prop.

Hypothesis true_for_lzero : forall m n:NNat, `m = 0 -> P m n.
Hypothesis ind_m : forall m n,  `m > 0  -> (forall p q, lex_lt p q m n = true -> P p q) -> P m n.

(*
Theorem nat_lex_ind (m n: NNat) :  P m n.
Proof.
